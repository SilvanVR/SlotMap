...
public:
    ...
    static_assert((GENERATION_BIT_COUNT + INDEX_BIT_COUNT) == (sizeof(Key) * 8),
        "Key bit-count MUST match the INDEX_BIT_COUNT + GENERATION_BIT_COUNT!");

    ///////////////////////////////////////////////////////////////////////////
    TSlotMap() = default;
    ~TSlotMap() { _Destroy(); }

    TSlotMap(const TSlotMap& other) { _CopyFrom(other); }
    TSlotMap& operator= (const TSlotMap& other)
    {
        _Destroy();
        _CopyFrom(other);
        return *this;
    ...
    TSlotMap(TSlotMap&& other) { _MoveFrom(std::move(other)); }
    TSlotMap& operator= (TSlotMap&& other)
    {
        _Destroy();
...
private:
    ...
    ///////////////////////////////////////////////////////////////////////////
    void _CopyFrom(const TSlotMap& other)
    {
